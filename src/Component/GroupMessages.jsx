...
export default class GroupMessages extends React.Component {
        ...
        fetch(process.env.REACT_APP_API_PATH + "/messages",
            {
                ...
                body: JSON.stringify({
                    ...
                    recipientGroupID: sessionStorage.getItem("groupID")
                }),
            }
        ).then((res) => res.json())
            .then((result) => {
    ...
    getMessageHistory() {
        ...
        fetch(process.env.REACT_APP_API_PATH + "/messages?recipientGroupID=" + sessionStorage.getItem("groupID"),
            {
                method: "GET",
                headers: {
                    "Content-Type": "application/json",
            ...
            .then((result) => {
                ...
                if (result[1] !== 0) {
                    ...
                    for (var i = 0; i < result[1]; i++) {
                        if(result[0][i].recipientGroup != null){       
