...
export default class PostForm extends React.Component {
  ...
  render() {
    ...
    return (
      ...
      <div>
          <button onClick={() => this.setState({ showing: !showing })} class="comment-button" > Click to Toggle Comment Box </button>
          { showing ?
            <div >
              <br />
              ...
              Comment Below
              <br />
              <textarea placeholder="Write a Comment Here!" rows="10" cols="70" onChange={this.myChangeHandler} />
              </label>
              <br />
